...
import MultiSelectDropdown from "./multi-select-dropdown" // Make sure this path is correct
            ...
            <Card className="h-full flex flex-col">
              ...
              <CardContent className="flex-grow">
                <Textarea
                  ...
                  readOnly
                  className="min-h-[400px] h-full font-mono resize-none" />
              </CardContent>
            </Card>
          ) : (
            <div
              className="h-full min-h-[400px] flex items-center justify-center border-2 border-dashed border-muted-foreground/25 rounded-lg p-8">
